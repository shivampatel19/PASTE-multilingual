...
class Encoder(nn.Module):
	def __init__(self, drop_out_rate):
		...
		if enc_type == 'BERT':
			...
			if bert_mode == 'gen_mul':
				self.BERT_model = BertModel.from_pretrained("bert-base-multilingual-uncased", output_attentions=True, output_hidden_states=False)
...
if __name__ == "__main__":
	...
	if bert_mode != 'gen' and bert_mode != 'gen_mul':
		trg_data_folder += 'pt'
	if optim == 'adamw':
	...
	if bert_mode == 'gen' or bert_mode == 'gen_mul':
